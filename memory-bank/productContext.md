...
1. **หน้าแรก (Dashboard View)**:
   ...
   - แถบเปลี่ยนพอร์ตหลักตามประเภท (Hold, Trade, Sale, List)
    - แดชบอร์ดสรุปผลเชิงตัวเลข (จำนวนหุ้น, ปันผลเฉลี่ย, ยอดตั้งซื้อทั้งหมด, ยอดซื้อรวม, ยอดขายรวม, ยอดกำไรรวม, ปันผลรวม, ภาษีรวม, และกำไรสุทธิ)
 2. **การควบคุมรายการ (Controls)**:
   ...
   - การเรียงลำดับอเนกประสงค์ (Sorting) เช่น เรียงตามยอดกำไร, กำไรสุทธิ, ราคาหุ้น, อัตราปันผล, ยอดปันผล, อายุการถือครอง, ซื้อล่าสุด และขายล่าสุด
3. **การ์ดข้อมูลหุ้นแบบละเอียด (Stock Cards)**:
   ...
   - แท็กสีแสดงสถานะการถือครอง (ซื้อแล้ว, ขายบางส่วน, ขายแล้ว) และป้ายบอกประเภทพอร์ตหลัก (Port Tag เช่น Hold, Trade, Sale, List) ข้างชื่อย่อหุ้น
   - แสดงอันดับมูลค่าตลาดโลก (World Top 100 Rank Tag) ของบริษัทขนาดใหญ่ เคียงคู่กับราคาหุ้นและการแสดงเปอร์เซ็นต์ราคาเปลี่ยนวันนี้ (Price Change Badge)
   - แสดงข้อมูลรายละเอียดทางการเงินและการวิเคราะห์เป็นตาราง Grid 11 ช่องที่มาพร้อมไอคอนสัญลักษณ์เฉพาะตัว (Decorative Icons) นำหน้าประเภทข้อมูล
   - ลิงก์จากข้อมูลหมวดหมู่ธุรกิจและอุตสาหกรรมในสหรัฐฯ ตรงไปยังหน้าสรุปสถิติตลาดของ TradingView เพื่อการเปิดอ่านวิเคราะห์ต่ออย่างฉับไว
...
4. **หน้าต่างอัปเดตข้อมูล (Update Modal)**:
   - แสดงข้อมูลหุ้น ราคาหุ้น เปอร์เซ็นต์ราคาเปลี่ยน และป้ายอันดับโลกบนหัวข้อ Modal
   - แสดงสถิติการลงทุนที่เกี่ยวข้องของหุ้นตัวนี้ (ราคาตั้งซื้อ, ยอดซื้อเดิม, ยอดปันผลเดิม ฯลฯ) เพื่อเป็นข้อมูลอ้างอิงระหว่างแก้ไข
   - แถบสรุปเป้าหมายและการคำนวณกำไร (Target Summary Cards) ด้านบน มีการใช้ไอคอนสัญลักษณ์ตกแต่งสำหรับข้อมูลแต่ละประเภท
