...
- **Responsive Layout**:
  ...
  - `stock-details-grid`: การ์ดหุ้นย่อย แสดงข้อมูลทางการเงินและการวิเคราะห์เป้าหมายรวม 11 รายการ ปรับโครงสร้างแบบยืดหยุ่น โดยแสดงเป็น Grid 6 คอลัมน์บนจอคอมพิวเตอร์ (`grid-template-columns: repeat(6, 1fr)`) และปรับเป็น 3 คอลัมน์อัตโนมัติบนหน้าจอมือถือ (`grid-template-columns: repeat(3, 1fr)`)
